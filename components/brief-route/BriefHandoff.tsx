    ...
    <section id="handoff" className={styles.root} aria-labelledby="handoff-title">
      ...
      <header className={styles.header}>
        ...
        <div className={styles.headingGrid}>
          ...
          <p>Спецификация нужна, чтобы следующий контакт уже был предметным. BND сначала разбирает вход, затем возвращает архитектуру и только после этого переводит задачу в production-контур.</p>
        </div>
      </header>
