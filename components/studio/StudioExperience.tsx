...
const MODES = [
  ...
  },
  {
    ...
    copy: "Типографика, анимация, WebGL и интерфейс работают не как декор, а как один визуальный механизм с понятной иерархией.",
    signal: "ИНТЕРФЕЙС / АНИМАЦИЯ / МАТЕРИАЛ",
  },
  {
    id: "connect",
    index: "03",
  ...
  },
  {
    ...
    index: "04",
    name: "ЗАПУСК",
    title: "Доводим систему до рабочего состояния.",
    copy: "QA, доступность, производительность, развёртывание, наблюдаемость и эксплуатация входят в продуктовую работу, а не остаются на потом.",
...
const PRINCIPLES = [
  ...
  ["04", "ЗАПУСТИТЬ / ПРОВЕРИТЬ / УЛУЧШИТЬ", "Запуск — часть дизайна. Релиз без проверки не считается завершением."],
] as const;
      ...
      <section className={styles.hero} aria-labelledby="studio-title">
        ...
        <div className={styles.heroShell}>
          ...
          <div className={styles.heroCopy} data-studio-copy>
            <p>Не агентство с набором услуг. Не продакшн, который заканчивается на макете. BND собирает цифровые системы целиком — от логики до живого продукта.</p>
